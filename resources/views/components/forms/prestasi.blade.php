...
<div>
    ...
    <div x-show="openSections.prestasi" x-collapse class="mt-4 p-5 bg-gray-50 rounded-lg shadow-inner">
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-4">
            <div class="sm:col-span-2">
                <label class="block text-sm font-medium text-gray-700">Nama Lomba/Prestasi</label>
                <input type="text" x-model="currentItem.lomba" placeholder="Tulis Nama Lomba"
            ...
            <div>
                ...
                <input type="text" x-model="currentItem.penyelenggara" placeholder="Tulis Penyelenggara"
                    class="mt-1 bg-white border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5">
            </div>
            <div>
                <label class="block text-sm font-medium text-gray-700">Predikat/Juara</label>
                <input type="text" x-model="currentItem.predikat" placeholder="Contoh: Juara 1"
                    class="mt-1 bg-white border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5">
            </div>
            <div>
            ...
            <div>
                ...
                <input type="number" x-model="currentItem.tahun" placeholder="Contoh: 2021"
                    class="mt-1 bg-white border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5">
            </div>
        </div>
