    ...
    <div x-show="openSections.pengalaman" x-collapse
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-4">
            ...
            <div>
                ...
                <input type="text" x-model="currentItem.pemberi_kerja" placeholder="Tulis Perusahaan"
                    class="mt-1 bg-white border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5">
            </div>
            <div>
            ...
            <div>
                ...
                <input type="number" x-model="currentItem.tahun_mulai" placeholder="Contoh: 2020"
                    class="mt-1 bg-white border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5">
            </div>
            <div>
                <label class="block text-sm font-medium text-gray-700">Tahun Berakhir</label>
                <input type="number" x-model="currentItem.tahun_berakhir" placeholder="Contoh: 2022 atau Kosongkan"
                    class="mt-1 bg-white border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5">
            </div>
        </div>
