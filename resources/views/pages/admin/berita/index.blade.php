    ...
    <x-cms_page title="Manajemen Berita" breadcrumb1="Admin" breadcrumb2="Informasi" breadcrumb3="Berita">
        ...
        <table class="min-w-full" id="berita-datatable">
            ...
            <tbody id="berita-table-body">
                <tr>
                    {{-- Menyesuaikan colspan menjadi 6 --}}
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.status === 'success' && response.data.data.length > 0) {
                            ...
                            allBerita.forEach(function(berita) {
                                ...
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap border-b border-gray-200">
                                        <img src="${berita.cover}" alt="Cover" class="w-24 h-16 object-cover rounded-md">
                                    </td>
                            ...
                            tableBody.html(
                                '<tr><td colspan="6" class="text-center py-10 text-gray-500">Tidak ada data berita yang ditemukan.</td></tr>'
                            );
                        }
                    },
                    error: function(xhr) {
