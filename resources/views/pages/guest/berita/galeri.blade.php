...
@section('main-content')
    ...
    <div class="p-4 sm:p-8 lg:p-20 bg-white">
        ...
        <div class="max-w-7xl mx-auto flex flex-row justify-between">
            <div class="flex flex-col cursor-pointer" onclick="location.href='{{ route('guest.majalah') }}'">
            ...
            <div class="flex flex-col items-end cursor-pointer" onclick="location.href='{{ route('guest.pengumuman') }}'">
